...
class TestEndpointCache:
    ...
    def test_user_caching(self, mock_session):
        ...
        mock_db = MagicMock()
        mock_user = User(
            id=1, email="test@example.com", full_name="Test User", is_active=True
        )
    ...
    def test_different_user_ids_cached_separately(self):
        ...
        redis_cache.set(
            "_get_user_by_id:1", {"id": 1, "email": "user1@example.com"}, 60
        )
        redis_cache.set(
            "_get_user_by_id:2", {"id": 2, "email": "user2@example.com"}, 60
        )
    ...
    def test_cache_invalidation_simulation(self):
        ...
        redis_cache.set(
            "_get_resume_by_id:resume_456", {"id": 456, "title": "Test Resume"}, 60
        )
