        ...
        <div className="prose prose-lg max-w-none space-y-8">
          <section>
            ...
            <p className="text-gray-700 mb-4">
              We collect information you provide directly to us when you create an account, build a resume, or contact us for support.
            </p>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
              ...
              <li>Generate and store your resume documents</li>
          ...
          <section>
            ...
            <p className="text-gray-700">
              ...
              <a href="mailto:privacy@resumade.com" className="text-emerald-600 hover:text-emerald-700">
                privacy@resumade.com
              </a>
            </p>
          </section>
        </div>
